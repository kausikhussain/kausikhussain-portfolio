...
function AIModeCore() {
  ...
  return (
    <group>
      ...
      <pointLight position={[10, 10, 10]} intensity={2.2} color="#06b6d4" />
      <pointLight position={[-10, -10, -10]} intensity={1.2} color="#3b82f6" />

      <R3FSparkles count={50} scale={7} size={3} speed={0.6} color="#06b6d4" />
      ...
      <Float speed={2.5} rotationIntensity={1.5} floatIntensity={1.8}>
        ...
        <mesh ref={ring1Ref} scale={2.5} rotation={[Math.PI / 4, 0, 0]}>
          ...
          <meshStandardMaterial color="#3b82f6" emissive="#3b82f6" emissiveIntensity={0.9} transparent opacity={0.8} />
        </mesh>

        {/* Outer Counter-Rotating Ring */}
        <mesh ref={ring2Ref} scale={3.1} rotation={[-Math.PI / 3, Math.PI / 6, 0]}>
          <torusGeometry args={[1, 0.02, 16, 100]} />
          <meshStandardMaterial color="#06b6d4" emissive="#06b6d4" emissiveIntensity={0.7} transparent opacity={0.6} />
        </mesh>
      </Float>
    </group>
  );
...
function CreativeModeCore() {
  ...
  return (
    <group>
      ...
      <R3FSparkles count={60} scale={8} size={4} speed={0.5} color="#f97316" />
